...
%%  
    function [fg,ax] = InversionPlot(HH,HV,CP,Psi,Z,ao,bd,figvis)
        ...
        Psi(Psi<ll) = nan;
        Psi(Psi>0.5) = nan;    
        c = flip(getPyPlot_cMap('tab20b',cmlength-1));
        cm3 = [c(81:100,:) ; c(61:80,:) ; c(41:60,:) ; c(21:40,:) ; c(1:20,:)];
%         load('PsiColorMap.mat');
%         cm3 = c;
        fnt = 14;
        limY = [Z(1) Z(end)];
...
%%
    function [ax] = UpdateInversionPlot(ax,HH,HV,PCP,dE,Z,cZ,ao,MP,EigVal)
        cm1 = getPyPlot_cMap('seismic',100);
        cm2 = copper(40);
        cm21 = jet(40);
        cm2(41:80,:) = cm21;
